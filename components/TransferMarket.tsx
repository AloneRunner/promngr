      ...
      <div className="bg-slate-800 rounded-lg shadow-xl border border-slate-700 overflow-hidden">
        <table className="w-full text-left border-collapse">
          <thead className="bg-slate-900/50 text-slate-400 text-xs uppercase">
            <tr>
              <th className="p-4 hidden md:table-cell">{t.pos}</th>
              <th className="p-4">Name</th>
              <th className="p-4 text-center hidden md:table-cell">{t.age}</th>
              ...
              <tr key={player.id} className="hover:bg-slate-700/30 transition-colors group">
                ...
                <td className="p-4 cursor-pointer" onClick={() => onPlayerClick(player)}>
                  ...
                  <div className="text-xs text-slate-500 flex items-center gap-1">
                    <span className="md:hidden bg-slate-800 text-slate-300 px-1 rounded text-[10px]">{player.position}</span>
                    {player.nationality}
                  </div>
                </td>
                <td className="p-4 text-center text-slate-300 hidden md:table-cell">{player.age}</td>
