...
• Finishing 3rd in League and running deep in the lower cup is more profitable than zero wins in the Champions League!`,
    ...
    onlineTop50: "TOP 50",
    onlineFindOpponent: "Find Opponent",
    onlineSyncing: "Syncing your squad...",
    onlineSearching: "Searching for opponent...",
    onlineOpponentFound: "Opponent Found!",
    onlineStartMatch: "Start Match!",
    onlineYourTeam: "Your Team",
    onlineOpponent: "Opponent",
    onlineBetaWarning: "Beta phase — ELO ratings will be reset periodically. System will become fairer as the player pool grows.",
    onlineCannotQuit: "You cannot quit an online match — you must finish it.",
    onlineNoOpponent: "Not enough players yet. Try again in a few minutes!",
    onlineRankings: "Online Rankings",
    onlineMyRank: "Your Rank",
    onlineAllLeagues: "All",
    onlineNoMatches: "No rankings yet.",
    onlineNoLeaguePlayers: "No players in this league.",
    onlineBetaPeriod: "Beta Period",
    onlineBetaLeaderboardWarning: "ELO ratings may reset daily or every other day. Think of this as pre-season — the real season is coming soon.",
    onlineLeagueSuffix: "League",
    onlineUnranked: "Unranked",
    onlineWinShort: "W",
    onlineDrawShort: "D",
    onlineLossShort: "L",
    onlineWinRateSuffix: "win rate",
    onlineNoMatchesYet: "No matches yet",
    onlineEloDiffTooLarge: "ELO gap too large",
    onlineChallengeSent: "Sent",
    onlineChallengeError: "Error",
    onlineChallenge: "Challenge",
    onlineIncomingChallenges: "Incoming Challenges",
    onlineDailyLimitReached: "Daily limit reached",
    onlineLeagueDiamond: "Diamond",
    onlineLeagueGold: "Gold",
    onlineLeagueSilver: "Silver",
