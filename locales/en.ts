...
• Finishing 3rd in League and running deep in the lower cup is more profitable than zero wins in the Champions League!`,
    ...
    devLetterGreeting: "Dear Players,",
    devLetterParagraph1: "Your feedback means a great deal to us. Every comment is carefully reviewed, and we continuously make balance adjustments and improvements based on what you share. This process will never stop.",
    devLetterParagraph2: "The achievements system is being gradually integrated into the game. Your manager's decisions and accomplishments on the pitch will earn new badges and rewards.",
    devLetterParagraph3: "I am also working on the team logos. If time allows, I am considering redesigning all of them from scratch for a more consistent, higher-quality look.",
    devLetterParagraph4: "We currently have three different match engines available. Each one offers a distinct feel — choose the one that suits your style best.",
    devLetterParagraph5: "If an online mode is added in the future, I plan to use the community's most preferred engine as the standard for that mode, ensuring a fair and consistent competitive environment.",
    devLetterParagraph6: "Thank you so much for your support and feedback. See you on the pitch! 🙏",
