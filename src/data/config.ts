...
export const LEAGUE_ATTENDANCE_RATES: Record<
  string,
  { min: number; max: number }
> = {
  tr: { min: 0.5, max: 0.95 }, // Turkey
  en: { min: 0.85, max: 1.0 }, // England
  es: { min: 0.65, max: 0.95 }, // Spain
  it: { min: 0.6, max: 0.9 }, // Italy
  de: { min: 0.88, max: 1.0 }, // Germany
  fr: { min: 0.7, max: 0.95 }, // France
  ar: { min: 0.6, max: 0.98 }, // Argentina
  br: { min: 0.65, max: 0.98 }, // Brazil
  na: { min: 0.7, max: 0.95 }, // USA
  jp: { min: 0.6, max: 0.9 }, // Japan
  kr: { min: 0.5, max: 0.85 }, // Korea
  au: { min: 0.4, max: 0.8 }, // Australia
  sa: { min: 0.3, max: 0.95 }, // Saudi (High variance)
  mx: { min: 0.6, max: 0.95 }, // Mexico
  cl: { min: 0.5, max: 0.9 }, // Chile
  uy: { min: 0.5, max: 0.9 }, // Uruguay
  co: { min: 0.5, max: 0.9 }, // Colombia
  ma: { min: 0.5, max: 0.95 }, // Morocco
  za: { min: 0.4, max: 0.85 }, // South Africa
  eg: { min: 0.4, max: 0.95 }, // Egypt
  car: { min: 0.3, max: 0.8 }, // Caribbean
  default: { min: 0.5, max: 0.8 },
};
