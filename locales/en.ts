export const EN_TRANSLATIONS = {
    ...
    engineClassicBanner: "Main engine — most realistic and balanced version.",
    engineClassicNote: "ℹ️ Note: New features added to Beta Engine on March 5, 2026. Check it out below.",
    engineClassicBetaUpdateNote: "💡 Major updates made to Beta Engine on March 5, 2026. Give it a try!",
    engineIkincBanner: "Arcade engine — to be optimized for low-end devices soon.",
    engineUcuncuBanner: "🎯 Beta Engine (March 5, 2026) — Major update! See details in engine selection.",
    engineUcuncuBannerDetailed: "🔥 March 5, 2026 - Beta Engine Update:\n\n⚙️ PHYSICS ENGINE:\n✓ Players now predict ball physics (friction/drag) accurately\n✓ Long pass targeting completely rewritten - air time + air resistance included\n✓ Interception points and pass reading use realistic physics\n\n🎯 TACTICS & POSITIONING:\n✓ Tactical board and live match positions now perfectly aligned (lineupIndex-based)\n✓ Roam OFF discipline strengthened - players stay in position\n✓ Wide players have lane preferences - reduced side-swapping\n✓ Midfield support runs controlled by tactics\n\n🥅 GOALKEEPER & DEFENSE:\n✓ Penalty save success rate increased\n✓ Elite goalkeepers more consistent in 1v1s\n✓ Low cross claim/punch decision system added\n\n⚽ SHOOTING & MECHANICS:\n✓ Shot angle geometry (lane distance, defender approach)\n✓ Corner kick deterministic targeting (near/far/edge)\n✓ 90°+ sharp turns cause momentum loss (realistic movement)\n\n📊 Result: Much smarter and more consistent gameplay!",
