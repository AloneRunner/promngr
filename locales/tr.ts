export const TR_TRANSLATIONS = {
    ...
    engineClassic: "Tavsiye edilen Ana Motor — En gerçekçi ve dengeli versiyon (Ufak kusurları olabilir)",
    engineIkinc: "Arcade Motor — Gelecekte düşük donanımlı cihazlar için daha basit bir hale getirilecek",
    engineUcuncu: "Deneysel Motor — Artık kullanılmıyor, yakında kaldırılacak. Lütfen ilk motoru seçin",
    ...
    engineUcuncuBanner: "Deneysel motor — artık desteklenmiyor, yakında oyundan kaldırılacak.",
