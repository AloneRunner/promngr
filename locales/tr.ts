...
• Ligde 3. olup alt kupada ilerlemek, Şampiyonlar Ligi'nde 0 çekmekten daha kârlı olabilir!`,
    ...
    devLetterParagraph1: "Geri bildirimleriniz bizim için son derece değerli. Her yorumu dikkatle inceliyor, buna göre dengelemeler ve iyileştirmeler yapıyoruz. Bu süreç kesintisiz devam edecek.",
    devLetterParagraph2: "Başarım sistemi oyuna yavaş yavaş entegre ediliyor. Menajerinizin sahada aldığı kararlar ve elde ettiği başarılar yeni rozetler ve ödüller kazandıracak.",
    devLetterParagraph3: "Takım logoları üzerinde de çalışıyorum. Zaman bulursam tüm logoları sıfırdan, daha tutarlı ve kaliteli biçimde yeniden tasarlamayı düşünüyorum.",
    devLetterParagraph4: "Şu an üç farklı maç motorumuz mevcut. Her birinin kendine özgü bir oyun hissi var; size en uygun olanını seçerek oynayabilirsiniz.",
    devLetterParagraph5: "İleride çevrim içi mod eklenirse, topluluğun en çok tercih ettiği motoru o mod için standart olarak kullanmayı planlıyorum. Böylece adil ve tutarlı bir rekabet ortamı oluşturabiliriz.",
    devLetterParagraph6: "Desteğiniz ve geri bildirimleriniz için çok teşekkür ederim. Sahada görüşmek üzere! 🙏",
