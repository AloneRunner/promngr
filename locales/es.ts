export const ES_TRANSLATIONS = {
    ...
    mentalityAttacking: "Agresivo",
    mentalityBalanced: "Equilibrado",
    mentalityDefensive: "Defensivo",
    ...
    engineChoiceDesc: "Elige qué motor de partido ejecutará la simulación en vivo.",
    engineClassic: "Motor Principal Recomendado — El más realista y equilibrado (puede tener pequeños fallos)",
    engineIkinc: "Motor Arcade — Se simplificará para dispositivos de gama baja en el futuro",
    engineUcuncu: "Motor Experimental — Ya no se utiliza, se eliminará pronto. Por favor selecciona el primero.",
    engineFeedbackLabel: "Comentarios sobre el motor",
    engineFeedbackPlaceholder: "Dinos por qué prefieres este motor (fallos, sensación, sugerencias)",
    engineSaveFeedback: "Gracias — comentario guardado localmente.",
    engineClassicBanner: "Motor principal — la versión más realista y en desarrollo activo.",
    engineIkincBanner: "Motor arcade — se aligerará para dispositivos de gama baja en el futuro.",
    engineUcuncuBanner: "Motor experimental — ya no es compatible, se eliminará del juego pronto.",
    changeEngine: "Cambiar Motor",
    learnMore: "Más Información",
    engineInfoAlert: "Puedes cambiar motores en Ajustes. Los comentarios se guardan localmente.",
    ...
    internationalEliteCup: "Copa Internacional Élite",
    internationalChallengeCup: "Copa Internacional Desafío",
    internationalSuperCup: "Supercopa Internacional",
    internationalTournament: "Torneo Internacional",
    viewTournamentDetails: "Ver Detalles del Torneo",
    currentStageLabel: "Etapa Actual",
    superCupSubtitle: "Campeón de Copa Internacional Élite vs Campeón de Copa Internacional Desafío",
...
• Resultado: Ganas 1-0, gol y a dormir.`,
    ...
    update330Item1Desc: "¡Los salarios ya no aumentan automáticamente! Solo se actualizan al firmar nuevo contrato. ¡Ficha jóvenes baratos!",
    update330Item2Title: "Reserva Mundial de Juveniles",
    update330Item2Desc: "Se acabaron los 'regens' de retirados. Ahora hay una reserva mundial de 80 jóvenes talentos cada temporada. Los equipos compiten con su poder de ojeo.",
    update330Item3Title: "Inflación del Mercado",
    update330Item3Desc: "A medida que los clubes se enriquecen, los precios suben. En 10 años, un jugador como Messi costará 200M€.",
    update330Item4Title: "Impuesto de Lujo FFP",
    update330Item4Desc: "Clubes con presupuesto >100M€ pagan impuesto semanal. Se reparte como 'Fondo de Solidaridad' al resto de la liga.",
    update330Item5Title: "Finanzas Detalladas & FFP",
    update330Item5Desc: "Pestaña de finanzas renovada. Seguimiento explícito de impuestos FFP y fondos de solidaridad.",
    ...
    showAnimationsDesc: "Mostrar animaciones y efectos de partidos",
    detailedStats: "Estadísticas Detalladas",
    detailedStatsDesc: "Mostrar estadísticas detalladas de jugadores y partidos",
    backgroundSimulation: "Simulación en Segundo Plano",
    backgroundSimulationDesc: "Mostrar pantalla de carga durante la simulación semanal (recomendado para móvil)",
    ...
    language: "Idioma",
    tip: "Consejo",
    performanceSettingsTip: "Si experimenta un rendimiento lento, desactive las animaciones y active la simulación en segundo plano.",
    cancel: "Cancelar",
    save: "Guardar",
    simulatingWeek: "Simulando Semana",
    pleaseWait: "Por favor espere mientras se procesan los partidos...",
    progress: "Progreso",
    simulatingLeagueMatches: "Simulando partidos de liga...",
    simulatingCupMatches: "Simulando partidos de copa...",
    updatingStatistics: "Actualizando estadísticas...",
    performanceTip: "Consejo: Puede desactivar animaciones en Configuración para simulación más rápida"
};