...
export const LEAGUE_TICKET_PRICES: Record<string, number> = {
    'tr': 18,     // Turkey average â‚¬18 (range â‚¬10-30)
    'en': 55,     // England average â‚¬55 (range â‚¬40-100)
    'es': 45,     // Spain average â‚¬45 (range â‚¬30-80)
    'it': 40,     // Italy average â‚¬40 (range â‚¬25-70)
    'de': 35,     // Germany average â‚¬35 (range â‚¬20-60)
    'fr': 40,     // France average â‚¬40 (range â‚¬25-70)
    'ar': 15,     // Argentina average â‚¬15 (range â‚¬8-25)
    'br': 12,     // Brazil average â‚¬12 (range â‚¬5-20)
    'default': 25
};
...
export const LEAGUE_PRESETS = [
    {
        ...
        realTeams: [
            ...
            { name: "Istanbul Eagles", city: "Istanbul", primaryColor: "#000000", secondaryColor: "#ffffff", reputation: 7600, budget: 35000000, stadiumCapacity: 42000 },
            ...
            { name: "Izmir Goz", city: "Izmir", primaryColor: "#FFFF00", secondaryColor: "#FF0000", reputation: 5800, budget: 10000000, stadiumCapacity: 20000 },
    ...
    },
    {
        ...
        realTeams: [
            ...
            { name: "Gladbach Foals", city: "MÃ¶nchengladbach", primaryColor: "#FFFFFF", secondaryColor: "#00603C", reputation: 7600, budget: 38000000, stadiumCapacity: 54057 },
...
const ALL_SQUADS = [
    ...
    MALLORCA_ISLANDERS_SQUAD, PAMPLONA_BULLS_SQUAD, GETAFE_BLUES_SQUAD,
    VITORIA_FOXES_SQUAD, ESPANYOL_PARROTS_SQUAD,
    // Reserves
