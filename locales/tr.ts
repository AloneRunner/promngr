export const TR_TRANSLATIONS = {
    ...
    clParticipationBody: "🏆 Şampiyonlar Ligi'ne katılıyorsunuz!",
    elParticipationBody: "🥈 UEFA Cup'a katılıyorsunuz!",
    clDrawSubject: "🏆 Şampiyonlar Ligi Kurası!",
    clDrawQualifiedBody: "Takımınız Şampiyonlar Ligi'ne katılmaya hak kazandı! Çeyrek final eşleşmeleri belli oldu.",
    clDrawNotQualifiedBody: "Şampiyonlar Ligi başladı. Takımınız bu sezon katılamadı.",
    clInvitationSubject: "🏆 Şampiyonlar Ligi Daveti!",
    clInvitationBody: "{team} olarak Şampiyonlar Ligi'ne davet edildiniz!",
    elInvitationSubject: "⚽ UEFA Avrupa Ligi Daveti!",
    elInvitationBody: "{team} olarak UEFA Avrupa Ligi'ne davet edildiniz!",
