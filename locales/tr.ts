export const TR_TRANSLATIONS = {
    ...
    engineClassicBanner: "Ana motor — en gerçekçi ve dengelenmiş versiyon.",
    engineClassicNote: "ℹ️ Not: 5 Mart 2026'da Beta Motora yeni özellikler eklendi. Aşağıdan göz atabilirsiniz.",
    engineClassicBetaUpdateNote: "💡 5 Mart 2026'da Beta motor üzerinde kapsamlı değişiklikler yapılmıştır. Test edebilirsiniz!",
    engineIkincBanner: "Arcade motor — ileride düşük donanımlı cihazlar için hafifletilecek.",
    engineUcuncuBanner: "🎯 Beta motor (5 Mart 2026) — Kapsamlı güncelleme! Motor seçim ekranından detayları görün.",
    engineUcuncuBannerDetailed: "🔥 5 Mart 2026 - Beta Motor Güncellemesi:\n\n⚙️ FİZİK MOTORU:\n✓ Oyuncular artık topun gerçek fiziğini (friction/drag) hesaplayarak hareket ediyor\n✓ Uzun pas hedefleme tamamen yenilendi - havada kalma süresi + hava direnci dahil\n✓ Kesme noktaları ve pas okuma sistemi doğru fizik kullanıyor\n\n🎯 TAKTIK & POZİSYON:\n✓ Taktik tahtası ve canlı maç pozisyonları 1:1 eşleşiyor (lineupIndex bazlı)\n✓ Roam OFF disiplini güçlendirildi - oyuncular artık pozisyonlarında kalıyor\n✓ Kanat oyuncuları kanal tercihleri - yan değiştirme azaldı\n✓ Orta saha destek koşuları taktiğe göre kontrol ediliyor\n\n🥅 KALECI & SAVUNMA:\n✓ Penaltı kurtarış başarısı artırıldı\n✓ 1v1 durumlarında elit kaleciler daha tutarlı\n✓ Alçak orta claim/punch karar sistemi eklendi\n\n⚽ ŞUT & OYUN MEKANİĞİ:\n✓ Şut açısı geometrisi (lane mesafesi, savunma yaklaşımı)\n✓ Köşe vuruşu deterministik hedefleme (ön/arka/kenar)\n✓ 90°+ ani dönüşlerde momentum kaybı (gerçekçi hareket)\n\n📊 Sonuç: Oyun çok daha akıllı ve tutarlı!",
