...
if ($startLine -ge 0 -and $endLine -gt $startLine) {
    ...
    $newCode = @"
            ...
            // BALANCED: Eski motor + Relative Confidence
            ...
            if (tactic.passingStyle === 'Direct') {
                ...
                dribbleScore += 10;
                passScore += 50;
                if (spaceObstacles.length === 0) dribbleScore += 25;
            } else if (tactic.passingStyle === 'Mixed') {
                dribbleScore += 25;
                if (spaceObstacles.length === 0) dribbleScore += 35;
            ...
            if (p.attributes.dribbling > 70) {
                dribbleScore += (tactic.passingStyle === 'Direct' ? 55 : 35);
            }
            ...
            if (nearestPresser && nearestPresserDist < 8) {
                ...
                if (skillDiff > 10) {
                    dribbleScore += [Math]::Min(40, skillDiff * 1.5);
                }
            }
...
"@
    ...
    Write-Host "ERROR: Section not found"
}
