export const TR_TRANSLATIONS = {
    ...
    engineUcuncu: "Beta Motor — Aktif geliştirme aşamasında. Stabil olmayabilir. Şu an üzerinde çalışılanlar: serbest vuruş fiziği, ver-kaç yapay zekası, ofsayt dönüşü ve agresiflik dengesi.",
